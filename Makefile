...
.PHONY: all
all: dependencies build/goform


build/goform: descriptors.go resources.go *.go
...
.PHONY: clean
CLEAN_FILES := build/goform resources.go descriptors.go $(RESOURCES)
clean:
